...
export default function TrackingModal({
  ...
  const [cctvFeedActive, setCctvFeedActive] = useState(true);
                ...
                {isLoading ? (
                  ...
                  <div className="h-[500px] flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                      We couldn't retrieve the live location for this shipment.
                    </p>
                  </div>
                ) : data ? (
                  <div className="flex flex-col h-[80vh] sm:h-[600px]">
                    <div className="px-6 py-4 border-b border-slate-100 dark:border-white/5 flex items-center justify-between shrink-0">
                      <div>
                        ...
                        >
                          Live Tracking
                          <span
                            className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest ring-1 
                                                        ${
                                                          data.shipment
                                                            .status ===
                                                          "DELAYED"
                        ...
                        <p className="text-sm text-slate-500 mt-1 flex items-center gap-2">
                          ...
                          {data.shipment.destination.name}
                        </p>
                      </div>
                      <div className="hidden sm:block text-right">
                        ...
                        {data.shipment.eta &&
                          new Date(data.shipment.eta).getTime() !==
                    ...
                    <div className="flex-1 flex overflow-hidden">
                      <div className="w-[70%] relative bg-slate-50">
                        <EnhancedTrackingMap
                      ...
                      <div className="w-[15%] border-l border-slate-200 dark:border-white/5 bg-white dark:bg-slate-950 hidden lg:flex flex-col overflow-y-auto">
                        ...
                        {data.delayRisk && (
                          ...
                          >
                            ...
                            <div className="flex items-start gap-3">
                              <div
                                className={`mt-0.5 w-2 h-2 rounded-full ring-2 ring-offset-2 ring-offset-white dark:ring-offset-slate-950 ${
                                  data.delayRisk.level === "high"
                              ...
                              <div>
                                ...
                                {data.delayRisk.level === "high" && (
                                  <p className="text-xs text-red-600/80 mt-1">
                                    Route optimization active to mitigate
                                    delays.
                                  </p>
                                )}
                              </div>
                            ...
                            const milestones = [
                              {
                                ...
                                label: "Order Created",
                                icon: Circle,
                                date: data.shipment.createdAt,
                              },
                              {
                                key: "ASSIGNED",
                                label: "Rider Assigned",
                                icon: ShieldCheck,
                                date: data.recentEvents?.find(
                                  (e: any) => e.type === "SHIPMENT_ASSIGNED",
                                )?.createdAt,
                              },
                              {
                                key: "PICKED_UP",
                              ...
                              },
                              {
                                ...
                                icon: Truck,
                                date: data.recentEvents?.find(
                                  (e: any) => e.type === "SHIPMENT_DISPATCHED",
                                )?.createdAt,
                              },
                              {
                                key: "DELIVERED",
                                ...
                                <div className="space-y-3">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-[10px] font-bold text-slate-400">
                                      {data.progressPercentage || 0}% Complete
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl border border-blue-200 dark:border-blue-900/30">
                                      <div className="text-[8px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-1">
                                        Distance
                                      </div>
                                      ...
                                      <div className="text-[7px] text-blue-600/70 dark:text-blue-400/70 font-medium">
                                        of{" "}
                                        {data.shipment.distanceKm
                                          ? `${Math.round(data.shipment.distanceKm)} km`
                                          : "--"}
                                      </div>
                                    </div>
                                    ...
                                    <div className="p-3 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-900/10 rounded-xl border border-emerald-200 dark:border-emerald-900/30">
                                      <div className="text-[8px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1">
                                        Progress
                                      </div>
                                ...
                                <div className="relative pl-8 space-y-4 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gradient-to-b before:from-blue-500 before:via-blue-300 before:to-slate-200 dark:before:to-slate-700">
                                  {milestones.map((m, idx) => {
                                    ...
                                    const isCurrent =
                                      ...
                                      (m.key === "PICKED_UP" &&
                                        data.shipment.status === "PICKED_UP");
                                    const relatedEvent =
                                      data.recentEvents?.find(
                                        (e: any) =>
                                          ...
                                          (m.key === "PICKED_UP" &&
                                            (e.type === "SHIPMENT_PICKED_UP" ||
                                              e.type === "MARK_LOADED")) ||
                                          (m.key === "IN_TRANSIT" &&
                                            e.type === "SHIPMENT_DISPATCHED") ||
                                          (m.key === "ASSIGNED" &&
                                            e.type === "SHIPMENT_ASSIGNED"),
                                      );
                                    ...
                                    return (
                                      ...
                                      >
                                        {/* Timeline Dot */}
                                        <div
                                          className={`absolute -left-8 h-6 w-6 rounded-full flex items-center justify-center z-10 border-2 transition-all duration-300
                                                                                    ${
                                                                                      isCompleted
                                                                                        ? "bg-blue-500 border-blue-400 text-white shadow-lg shadow-blue-500/40"
                                                                                        : isCurrent
                                                                                          ? "bg-amber-500 border-amber-400 text-white animate-pulse shadow-lg shadow-amber-500/40"
                                        ...
                                        <div
                                          className={`rounded-xl border-2 transition-all duration-300 ${
                                            isCompleted
                                              ? "bg-white dark:bg-slate-800/50 border-blue-200 dark:border-blue-900/30"
                                              : isCurrent
                                                ? "bg-amber-50 dark:bg-amber-900/10 border-amber-300 dark:border-amber-900/40"
                                                      ...
                                                      {role === "MANAGER" && (
                                                        <div className="mt-2 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-white/5 space-y-2">
                                                          <div className="flex items-center gap-2 flex-wrap">
                                                            <span className="text-[8px] font-bold text-emerald-500 uppercase tracking-widest px-2 py-0.5 bg-emerald-500/10 rounded">
                                                              ✓ Verified
                                                            </span>
                                                          ...
                                                          {relatedEvent?.location && (
                                                            <div className="text-[9px] text-slate-500">
                                                              ...
                                                              {relatedEvent
                                                                .location
                                                                .name ||
                                                                `${relatedEvent.location.lat?.toFixed(4)}, ${relatedEvent.location.lng?.toFixed(4)}`}
                                                            </div>
                                                          )}
                                                            ...
                                                            return recentAchievements.map(
                                                              (
                                                                ...
                                                                >
                                                                  {/* Timeline Dot */}
                                                                  <div
                                                                    className={`absolute -left-6 h-4 w-4 rounded-full border-2 border-white dark:border-slate-900 flex items-center justify-center shadow-lg ${
                                                                      achievement.color ===
                                                                      "blue"
                                                                        ? "bg-blue-500"
                                                                        : achievement.color ===
                                                                          ...
                                                                          : achievement.color ===
                                                                            ...
                                                                            : achievement.color ===
                                                                              ...
                                                                              : achievement.color ===
                                                                                ...
                                                                                : achievement.color ===
                                                                                    "pink"
                                                                                  ? "bg-pink-50 dark:bg-pink-900/10 border-pink-200 dark:border-pink-900/30"
                                                          ...
                                                          <p className="text-[10px] text-slate-700 dark:text-slate-300 font-medium">
                                                            ...
                                                            90
                                                              ...
                                                              : data.progressPercentage >=
                                                                ...
                                                                : data.progressPercentage >=
                                                                    50
                                                                  ? "⚡ Cruising smoothly - Halfway complete"
                                                                  : data.progressPercentage >=
                                                                      25
