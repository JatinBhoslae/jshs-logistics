...
export default function ManagerLiveTrackingModal({
  shipmentId,
  onClose,
}: ManagerLiveTrackingModalProps) {
                ...
                {isLoading ? (
                  ...
                  <div className="flex flex-col h-[95vh]">
                    ...
                    <div className="p-4 bg-gradient-to-r from-rose-600 via-rose-500 to-orange-500 text-white">
                      ...
                      <div className="mt-4 grid grid-cols-5 gap-3">
                        <div className="bg-white/10 backdrop-blur-md rounded-lg p-2 border border-white/20">
                          <div className="text-[8px] font-bold text-white/70 uppercase tracking-widest mb-0.5">
                            Status
                          </div>
                    ...
                    <div className="flex-1 flex overflow-hidden">
                      {/* LEFT: Map - 70% */}
                      <div className="w-[70%] relative bg-slate-800">
                        <EnhancedTrackingMap
                      ...
                      {/* MIDDLE: Analytics & Events - 15% */}
                      <div className="w-[15%] bg-slate-800 border-l border-slate-700 overflow-y-auto p-4 space-y-4">
                        {/* Real-Time Analytics */}
                        <div className="bg-slate-900 rounded-xl border border-slate-700">
                          ...
                          >
                            ...
                            <ChevronDown
                              className={`h-4 w-4 text-slate-400 transition-transform ${expandedSections.analytics ? "rotate-180" : ""}`}
                            />
                          </button>
                          <AnimatePresence>
                              ...
                              >
                                <div className="p-3 space-y-2 border-t border-slate-700">
                                  <div className="p-2 bg-slate-800 rounded-lg">
                                    <div className="text-[8px] text-slate-400 font-bold uppercase mb-1">
                                      Avg Speed
                                    </div>
                                    <div className="text-lg font-black text-white">
                                      {data.vehicleHealth?.speed || "--"} km/h
                                    </div>
                                  </div>
                                  <div className="p-2 bg-slate-800 rounded-lg">
                                    <div className="text-[8px] text-slate-400 font-bold uppercase mb-1">
                                  ...
                                  <div className="p-2 bg-slate-800 rounded-lg">
                                    ...
                                    <div className="text-lg font-black text-blue-400">
                                      {data.vehicleHealth?.healthScore || "--"}
                                      /100
                                    </div>
                                  </div>
                                  <div className="p-2 bg-slate-800 rounded-lg">
                        ...
                        <div className="bg-slate-900 rounded-xl border border-slate-700">
                          ...
                          >
                            ...
                            <ChevronDown
                              className={`h-4 w-4 text-slate-400 transition-transform ${expandedSections.events ? "rotate-180" : ""}`}
                            />
                          </button>
                          <AnimatePresence>
                        ...
                        <div className="bg-slate-900 rounded-xl border border-slate-700">
                          ...
                          >
                            ...
                            <ChevronDown
                              className={`h-4 w-4 text-slate-400 transition-transform ${expandedSections.vehicle ? "rotate-180" : ""}`}
                            />
                          </button>
                          <AnimatePresence>
                              ...
                              >
                                <div className="p-3 space-y-2 border-t border-slate-700">
                                  ...
                                  <div className="text-sm font-bold text-slate-300">
                                    {data.shipment.assignedVehicle?.type ||
                                      "N/A"}
                                  </div>
                                  <div className="text-[9px] text-slate-400 font-bold uppercase mt-2">
                                    Capacity
                                  ...
                                  <div className="text-sm font-bold text-slate-300">
                                    {data.shipment.assignedVehicle?.capacity ||
                                      "--"}{" "}
                                    kg
                                  </div>
                                </div>
                      ...
                      {/* RIGHT: Detailed Info & Controls - 15% */}
                      <div className="w-[15%] bg-slate-850 border-l border-slate-700 overflow-y-auto p-4 space-y-4">
                        {/* Driver Info */}
                        <div className="bg-slate-900 rounded-xl p-4 border border-slate-700">
                          ...
                          <div className="flex items-center gap-3 mb-3">
                            <div className="h-12 w-12 rounded-full bg-gradient-to-br from-rose-400 to-orange-600 flex items-center justify-center text-white font-black text-lg">
                              {data.shipment.assignedDriver?.name?.charAt(0) ||
                                "D"}
                            </div>
                            <div>
                              <div className="text-sm font-black text-white">
                                {data.shipment.assignedDriver?.name ||
                                  "Unassigned"}
                              </div>
                              <div className="text-xs text-slate-400">
                                {data.shipment.assignedDriver?.phone || "N/A"}
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="bg-slate-900 rounded-xl p-4 border border-slate-700">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="text-xs font-bold text-white">
                                {data.shipment.packageType || "Standard"}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-xs text-slate-400">
                        ...
                        <div className="bg-slate-900 rounded-xl border border-slate-700">
                          ...
                          >
                            ...
                            <ChevronDown
                              className={`h-4 w-4 text-slate-400 transition-transform ${expandedSections.cctv ? "rotate-180" : ""}`}
                            />
                          </button>
                          <AnimatePresence>
                              ...
                              >
                                <div className="p-3 border-t border-slate-700">
                                      ...
                                      {cctvFeedActive ? (
                                        <div className="text-center">
                                          ...
                                          <div className="text-xs text-slate-500 mt-1">
                                            {data.shipment.assignedDriver?.name
                                              ? `Driver: ${data.shipment.assignedDriver.name}`
                                              : "No Driver Assigned"}
                                          </div>
                                        </div>
                                      ) : (
                                        <div className="text-center">
                                          <div className="h-12 w-12 rounded-full bg-slate-600 flex items-center justify-center mx-auto mb-2">
                                  ...
                                  <div className="mt-2 flex gap-2">
                                    <button
                                      onClick={() =>
                                        setCctvFeedActive(!cctvFeedActive)
                                      }
                                    ...
                                    <button className="p-2 bg-blue-500/20 text-blue-300 rounded text-xs font-bold border border-blue-500/30 hover:bg-blue-500/30 transition-colors">
                                      Full Screen
                                    </button>
                                  </div>
                                </div>
