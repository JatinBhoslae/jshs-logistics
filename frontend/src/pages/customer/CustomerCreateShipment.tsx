...
export default function CustomerCreateShipment() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        customPrice:
          pricingMode === "CUSTOM"
            ? Number(customPrice) || undefined
            : undefined,
        category:
          formData.category === "CUSTOM" ? undefined : formData.category,
        customCategory:
          formData.category === "CUSTOM"
            ? formData.customCategory || undefined
            : undefined,
        packageDetails: {
        ...
        consigneeContact: formData.consigneeContact.startsWith("+91")
          ? formData.consigneeContact
          : `+91${formData.consigneeContact}`,
      };
      ...
      if (
        (res.data.paymentOption || paymentOption) === "PAY_NOW" &&
  ...
  const handlePayment = () => {
    ...
    // Dynamic loading of Razorpay if not present
    if (!window.Razorpay) {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Book a new consignment with real-time AI categorization.
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="flex flex-col items-center gap-2">
            ...
            <span
              className={`text-xs font-medium ${step === i + 1 ? "text-indigo-600" : "text-slate-500"}`}
            >
              {s.label}
            </span>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="glass-card p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <label className="text-sm font-medium">
                  Upload Photos of Goods (For AI Categorization)
                </label>
          ...
          <div className="space-y-6">
            <div className="glass-card p-6 bg-gradient-to-br from-indigo-500/10 to-cyan-500/10 border-indigo-200 dark:border-indigo-500/20">
              ...
              <p className="text-xs text-slate-500 mt-2">
                Includes base price, distance fees, and weight surcharges.
              </p>
              ...
              <div className="mt-6 space-y-3 pt-6 border-t border-slate-200 dark:border-white/10">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedCost - 100 - formData.weight * 2)}
                  </span>
                </div>
              ...
              <div className="flex gap-3 text-amber-700 dark:text-amber-400">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1 opacity-80">
                    Shipments created by customers require manager approval
          ...
          <div className="glass-card p-8 text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-2">
                Finish booking by paying the demonstration fee of ₹1.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/5 text-left">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-500 mb-4">
                  <div
                    className={`h-2 w-2 rounded-full ${createdShipment?.aiCategorization?.category !== "UNKNOWN" ? "bg-indigo-500" : "bg-slate-300"}`}
                  />
                  {createdShipment?.aiCategorization?.category !== "UNKNOWN" ? (
                    <span>
                      ...
                      <span className="font-bold text-indigo-600 uppercase">
                        {createdShipment?.aiCategorization?.category}
                      </span>
                    </span>
                  ) : (
